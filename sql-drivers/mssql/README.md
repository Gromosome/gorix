...
# Gorix Microsoft SQL Server Driver Adapter

Registers the Microsoft SQL Server adapter with `github.com/Gromosome/gorix/sql-driver-manager`.
...
```go
import (
	_ "github.com/Gromosome/gorix/sql-drivers/mssql"
)
```
