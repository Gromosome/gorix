...
# Gorix MySQL Driver Adapter

Registers the MySQL adapter with `github.com/Gromosome/gorix/sql-driver-manager`.
...
```go
import (
	_ "github.com/Gromosome/gorix/sql-drivers/mysql"
)
```
